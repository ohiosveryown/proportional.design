...
vec2 coverUvs(vec2 imageRes,vec2 containerRes)
{
  ...
  vec2 ratio=vec2(
    min(containerAspectX/imageAspectX,1.),
    min(containerAspectY/imageAspectY,1.)
  );
...
void main()
{
  ...
  vec2 finalUvs=newUvs-displacement.rg*.003;
  ...
  */
  ...
  vec2 shift=displacement.rg*.0005;
